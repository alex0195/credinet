...
<div class="pun"><div class="block"><h2 align="center"><span>INGRESOS POR GASTOS ADMINISTRATIVOS</span></h2><div class="box"><div class="inbox">
<script>
...
<form method="post" action="gadmin.asp?id=<%=request("id")%>" name="datos">
